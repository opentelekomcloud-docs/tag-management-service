...
-  Adding tags on the consoles of other cloud services
   ...
   When you use the resources of a specific service, you can add, modify, and delete tags on the corresponding service console. For new cloud resources, you can configure tag items when configuring parameters.
...
.. |image1| image:: /_static/images/en-us_image_0000002502623003.png
