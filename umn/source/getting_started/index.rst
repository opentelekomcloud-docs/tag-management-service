...
-  Adding tags on the consoles of other cloud services
   ...
   When you use the resources of a specific service, you can add tags on the corresponding service console. You can configure tags for cloud resources when creating them.

   .. note::

      -  Predefined tags allow you to tag resources without entering tag keys and values. Predefined tags are more efficient and less error-prone.
...
#. Log in to the TMS management console.
...
-  :ref:`Adding Tags to Cloud Resources <en-us_topic_0056266261>`

.. |image1| image:: /_static/images/en-us_image_0000002285916460.png
.. |image2| image:: /_static/images/en-us_image_0000002320589057.png

.. toctree::
   :maxdepth: 1
   :hidden: 

   adding_tags_to_cloud_resources
